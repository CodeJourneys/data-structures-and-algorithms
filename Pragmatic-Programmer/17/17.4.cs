...
* If the user's string is not in the trie, 
* the function should return an alternative word that shares the longest possible prefix with the user's string.
*
...
*
* One more example: if the user types in "caxasfdij", 
* the function should return any of the words "cat", "catnap", and "catnip"
...
* This should be true even if the user's text is not a complete word, as we're only trying to correct typos,
* not suggest endings to the user's prefix.
*/